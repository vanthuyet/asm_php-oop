...
use Admin\Xuongoop\Controllers\Client\DetailController;
use Admin\Xuongoop\Controllers\Client\HomeController;
use Admin\Xuongoop\Controllers\Client\ListController;
...
$router->get('/post-detail/{id}',DetailController::class   . '@productDetail');
